#include<stdio.h>
char x,y[20],z[50],q[60],w,Q;
int a,b,c,d,f,i,k,choice,print_year,print_month,print_day,pay_day,pay_month,pay_yearpay_day;
...
int Details()
{
    ...
    scanf("%d%*c%d%*c%d",&print_day,&print_month,&print_year);
        ...
        case 1:
        {
            ...
            if(0<c)
            {
...

                {
                    ...
                    else if(l<10000 && l>=1000)
                    {
                        printf("\t     %.2f  |",l);

                    }
                    else if(l<100000 && l>=10000)
                    {
                        printf("\t    %.2f  |",l);
                    }
                    else if(l<1000000 && l>=100000)
                    {
                        printf("\t   %.2f  |",l);
                    }
                    else if(l<10000000 && l>=1000000)
                    {
                        printf("\t  %.2f  |",l);
                    }
                    else
...
int Date_calculation()
{
    printf("Bill pay date(dd/mm/yyyy ) : ");
    scanf("%d%*c%d%*c%d",&pay_day,&pay_month,&pay_year);
